...
Fraction of fakes is replaced with absolute number of events where predicted pT &gt; threshold

Comparing pT prediction in baseline and "myModel" on Andrew's zero bias ntuples:
...
Baseline is put on "myModel" scale (turn-ons cross at 50%) multiplying thresholds by $1.43$
