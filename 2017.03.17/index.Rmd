...
vars3p <- with(vars,data.frame( muPtGenInv,
                                ptTrg,
                           msb(abs(theta),7,0) + ifelse(ring1==1 || ring1==4, 0, 6),
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,10)),
                           abs(sat(dPhi34,10)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
...
vars5p <- with(vars,data.frame( muPtGenInv,
                                ptTrg,
                           msb(abs(theta),7,2) + ifelse(ring1==1 || ring1==4, 0, 6),
                           msb(abs(sat(dPhi12,10)),10,3),
                           abs(sat(dPhi23,5)),
                           abs(sat(dPhi34,5)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,10)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*abs(sat(dPhi23,5)), # analogous to dPhi13
                           msb(abs(sat(dPhi12,10)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*abs(sat(dPhi23,5)) + ifelse(dPhi34*dPhi12>=0,1,-1)*abs(sat(dPhi34,5)),
                           abs(sat(dPhi23,5))    + ifelse(dPhi34*dPhi12>=0,1,-1)*abs(sat(dPhi34,5)), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
...
vars5pp <- with(vars,data.frame( muPtGenInv,
                           ...
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,10)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3), # analogous to dPhi13
                           msb(abs(sat(dPhi12,10)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3),
                           msb(abs(sat(dPhi23,8)),8,3)   + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
                             )
...
vars6 <- with(vars,data.frame( muPtGenInv,
                           ...
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,9)),9,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3), # analogous to dPhi13
                           msb(abs(sat(dPhi12,9)),9,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3),
                           msb(abs(sat(dPhi23,8)),8,3) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
...
vars7 <- with(vars,data.frame( muPtGenInv,
                           ...
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,9)),9,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2), # analogous to dPhi13
                           msb(abs(sat(dPhi12,9)),9,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2),
                           msb(abs(sat(dPhi23,7)),7,2) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
                             )
...
vars8 <- with(vars,data.frame( muPtGenInv,
                               ptTrg,
                           msb(abs(theta),7,3) + ifelse(ring1==1 || ring1==4, 0, 6),
                           msb(abs(sat(dPhi12,10)),10,2),
                           msb(abs(sat(dPhi23,7)),7,2),
                           msb(abs(sat(dPhi34,7)),7,2),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,10)),10,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2), # analogous to dPhi13
                           msb(abs(sat(dPhi12,10)),10,2) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2),
                           msb(abs(sat(dPhi23,7)),7,2)   + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
...
vars9 <- with(vars,data.frame( muPtGenInv,
                           ...
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,9)),9,1) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2), # analogous to dPhi13
                           msb(abs(sat(dPhi12,9)),9,1) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,7)),7,2) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2),
                           msb(abs(sat(dPhi23,7)),7,2) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,7)),7,2), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
...
The best compression scheme appears to be scheme #7:
...
In this scheme I've used Andrews idea about combining $ring1$ and $\theta$ and his proposal for the bit widths of the predictors
