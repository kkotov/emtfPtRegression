...
vars1 <- with(vars,data.frame( muPtGenInv,
                           abs(msb(theta,10,0)) + ifelse(ring1==1 || ring1==4, 0, 6),
                           ptTrg,
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,10)),
                           abs(sat(dPhi34,10)),
...
vars3 <- with(vars,data.frame( muPtGenInv,
                           abs(msb(theta,7,2)) + ifelse(ring1==1 || ring1==4, 0, 6),
                           ptTrg,
                           abs(sat(dPhi12,7)),
                           abs(sat(dPhi23,5)),
                           abs(sat(dPhi34,5)),
...
type | $\theta$ | $\Delta\phi_{12}$ | $\Delta\phi_{23}$ | $\Delta\phi_{34}$ | $S^\phi_{12,23}$ | $S^\phi_{12,34}$ | $\Delta\theta_{12}$ | $\Delta\theta_{23}$ | $\Delta\theta_{34}$ | $\Delta\theta_{13}$ | $\Delta\theta_{14}$ | $\Delta\theta_{24}$ | clct | fr
-----|----------|-------------------|-------------------|-------------------|------------------|------------------|---------------------|---------------------|---------------------|---------------------|---------------------|---------------------|---------------|-----------
#4'  |  10      |      10           |       10          |        10         |         1        |        1         |        `0`          |        `0`           |        `0`         |         `0`         |         `3`         |         `0`         |  4,4,4,4 | 1,1,1,1 
...
vars4p <- with(vars,data.frame( muPtGenInv,
                                ptTrg,
                           abs(msb(theta,10,0)) + ifelse(ring==1 || ring==4, 0, 6),
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,10)),
                           abs(sat(dPhi34,10)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
...
colnames(vars4p) <- c("muPtGenInv", "ptTrg", predictors3 )
...
invisible( capture.output( modelFit4p <- ranger(f3, data=trainSet4p, importance="impurity") ) )
```
...
vars5pp <- with(vars,data.frame( muPtGenInv,
                                 ptTrg,
                           abs(msb(theta,7,3)) + ifelse(ring1==1 || ring1==4, 0, 6),
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,4)),
                           abs(sat(dPhi34,4)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
...
colnames(tszb4p) <- c("ptRef", predictors3 )
...
tszb5pp <- with(tszb,data.frame( ptRef,
                           abs(msb(theta,6,2)) + ifelse(ring1==1 || ring1==4, 0, 6),
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,4)),
                           abs(sat(dPhi34,4)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
...
compspPlot <- ggplot(compspDF, aes(y = truePos, x = falsePos, group = model, colour = model)) +
        ...
        scale_colour_manual(values = c("baseline"     = "#F8766D",
                            ...
                            breaks = c("baseline", "uncompres.", "scheme #4'", "scheme #5'", "scheme #5''"),
                            labels = c("baseline", "uncompres.", "scheme #4'", "scheme #5'", "scheme #5''")
        ) +
