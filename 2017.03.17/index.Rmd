...
```{r, fig.height=3., fig.width=3., fig.align = 'center', comment = NA, message = F, echo = F, dev='svg'}
barplot( modelFit1$variable.importance, horiz=T, col='red', xlab='Delta MSE', las=2 )#, main='Scheme #1' )
```

*** =right

```{r, fig.height=3., fig.width=3., fig.align = 'center', comment = NA, message = F, echo = F, dev='svg'}
barplot( modelFit2$variable.importance, horiz=T, col='red', xlab='Delta MSE', las=2 )#, main='Scheme #2' )
```
...
-----|----------|-------------------|-------------------|-------------------|------------------|------------------|---------------------|---------------------|---------------------|---------------------|---------------------|---------------------|---------------|-----------
#1   |  10      |      10           |        10         |         10        |         1        |        1         |         5           |         5            |         5          |         5           |       5             |           5         |  4,4,4,4 | 1,1,1,1 
#5'  |  5       |      10           |        10         |         10        |         1        |        1         |         0           |         0            |         0          |          0          |          2          |          0          |  2,0,0,0 | 0,0,0,0 
#5'' |  5       |      10           |        10         |         10        |         1        |        1         |         0           |         0            |         0          |          0          |          2          |          0          |  2,0,0,0 | 0,0,0,0 
