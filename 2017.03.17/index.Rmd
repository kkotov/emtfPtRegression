...
Schemes #2, #3, and #4 demonstrate almost identical performance for thresholds below 50 GeV/$c$ ($y$>0.8)
...
```{r, fig.height=3.5, fig.width=3.5, fig.align = 'center', comment = NA, message = F, echo = F, dev='svg'}
...
myTurnOnComp5p <- pp4p$getMyTurnOn()
rm(pp4p)
```
