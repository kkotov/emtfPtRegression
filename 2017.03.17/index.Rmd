...
compspPlot <- ggplot(compspDF, aes(y = truePos, x = falsePos, group = model, colour = model)) +
        ...
        scale_colour_manual(values = c("baseline"     = "#F8766D",
                            ...
                            breaks = c("baseline", "uncompressed", "scheme #4'", "scheme #5'", "scheme #5''"),
                            labels = c("baseline", "uncompressed", "scheme #4'", "scheme #5'", "scheme #5''")
        ) +
...
effRateCompspDF <- rbind( data.frame( eff   = roc1[["refEff"]],
                                      rate  = myRate,
                                      model = rep("uncompressed",nBins)
                          ),
                          effRateCompspDF
