...
----|----------|-------------------|-------------------|-------------------|------------------|------------------|---------------------|------|-----
#3' |  7       |     `10`          |       10          |        10         |         1        |        1         |       [3:0]         | 4,4,4,4 | 1,1,1,1
#6  |  [7:2]   |   `[10:3]`        |     `[8:3]`       |      `[8:3]`      |         1        |        1         |       [2:0]         | 2,0,0,0 | 1,0,0,0
...
vars6 <- with(vars,data.frame( muPtGenInv,
                           ...
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
                           as.factor(ifelse(dPhi34*dPhi12>=0,0,1)),
                           msb(abs(sat(dPhi12,9)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3), # analogous to dPhi13
                           msb(abs(sat(dPhi12,9)),10,3) + ifelse(dPhi23*dPhi12>=0,1,-1)*msb(abs(sat(dPhi23,8)),8,3) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3),
                           msb(abs(sat(dPhi23,8)),8,3) + ifelse(dPhi34*dPhi12>=0,1,-1)*msb(abs(sat(dPhi34,8)),8,3), # analogous to dPhi24
                           abs(sat(dTheta14,2)),
                           c(0,0,0,0,1,1,2,2,3,3,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(clct1)),0xF)+1],
                           fr1
