...
vars1 <- with(vars,data.frame( muPtGenInv,
                           msb(theta + ifelse(ring1==1 || ring1==4, 0, 6),10,0),
                           ptTrg,
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,10)),
                           abs(sat(dPhi34,10)),
...
vars3 <- with(vars,data.frame( muPtGenInv,
                           msb(theta + ifelse(ring1==1 || ring1==4, 0, 6),7,2),
                           ptTrg,
                           abs(sat(dPhi12,7)),
                           abs(sat(dPhi23,5)),
                           abs(sat(dPhi34,5)),
...
vars3p <- with(vars,data.frame( muPtGenInv,
                                ptTrg,
                           msb(theta + ifelse(ring1==1 || ring1==4, 0, 6),7,0),
                           abs(sat(dPhi12,10)),
                           abs(sat(dPhi23,10)),
                           abs(sat(dPhi34,10)),
                           as.factor(ifelse(dPhi23*dPhi12>=0,0,1)),
...
vars8 <- with(vars,data.frame( muPtGenInv,
                               ptTrg,
                           msb(theta + ifelse(ring1==1 || ring1==4, 0, 6),7,3),
