...
$\alpha^{set}/\alpha^{fit}$ | 2/`r signif(fitIdealExpFine$estimate[2],2)` , 0/`r signif(fitIdealPowFine$estimate[2],2)` | 2/`r signif(fitIdealExpCoarse$estimate[2],2)` , 0/`r signif(fitIdealPowCoarse$estimate[2],2)` | 2/`r signif(fitRealExp$estimate[2],2)` , 0/`r signif(fitRealPow$estimate[2],2)`
$B^{set}/B^{fit}$           | 0/`r signif(fitIdealExpFine$estimate[3],2)` , 1/`r signif(fitIdealPowFine$estimate[3],2)` | 0/`r signif(fitIdealExpCoarse$estimate[3],2)` , 1/`r signif(fitIdealPowCoarse$estimate[3],2)` | 0/`r signif(fitRealExp$estimate[3],2)` , 1/`r signif(fitRealPow$estimate[3],2)`
$\beta^{set}/\beta^{fit}$   | 0/`r signif(fitIdealExpFine$estimate[4],2)` , 3/`r signif(fitIdealPowFine$estimate[4],2)` | 0/`r signif(fitIdealExpCoarse$estimate[4],2)` , 3/`r signif(fitIdealPowCoarse$estimate[4],2)` | 0/`r signif(fitRealExp$estimate[4],2)` , 3/`r signif(fitRealPow$estimate[4],2)`
$b^{set}/b^{fit}$           | 0/`r signif(fitIdealExpFine$estimate[5],2)` , 0/`r signif(fitIdealPowFine$estimate[5],2)` | 0/`r signif(fitIdealExpCoarse$estimate[5],2)` , 0/`r signif(fitIdealPowCoarse$estimate[5],2)` | 0/`r signif(fitRealExp$estimate[5],2)` , 0/`r signif(fitRealPow$estimate[5],2)`
