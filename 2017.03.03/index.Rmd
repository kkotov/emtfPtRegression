...
Power law is a rather crude approximation, exponent + power law works better:
...
But quantile-quantile plot is not diagonal $\rightarrow$ the fit is still not ideal of course:
...
# source https://github.com/tidyverse/ggplot2/blob/master/R/stat-qq.r turned out to be crucial for implementing qqPlot
...
qwe For the moment I'll stick with these fit keeping in mind the excluded [1-2] GeV/$c$ bin

--- .class #id

## "Deconvoluting" the ideal spectrum

Using the fit above and turn-ons from the [last talk](https://kkotov.github.io/emtfPtRegression/2017.02.10/#5)
