...
rate2.7 <- sapply(binning[2:nBins], function(x) sum(pt3 > x) )
...
qqPlot <- ggplot( data.frame(qqplot(x=pt2.7, y=ptMes, plot.it=FALSE)) ) +
        ...
        labs( x=expression(paste(1/p[T] ^2.7, " spectrum")),
