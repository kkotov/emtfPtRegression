...
Construct likelihood $-2 \Sigma (r - e R)^2$ where 

Using the parametric form above and turn-ons from the [last talk](https://kkotov.github.io/emtfPtRegression/2017.02.10/#5) I can 
...
binLikeliConv <- function(par, turnOn, rate) {
    ...
    sum( (rate - ((t(turnOn) %*% estRate) + rate[nBins]))^2 )
}
