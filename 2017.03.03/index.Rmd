...
Parameter                   | $\gamma$=100, 1K bins | $\gamma$=100, 100 bins | $\gamma$=0.1, 100 bins | [real turn-on](https://kkotov.github.io/emtfPtRegression/2017.02.10/#5)
----------------------------|------------------------|-------------------------|-------------------------|---------------
$A^{set}/A^{fit}$           | 1/`r signif(fitIdealExpFine$estimate[1],2)` , 0/`r signif(fitIdealPowFine$estimate[1],2)` | 1/`r signif(fitIdealExpCoarse$estimate[1],2)` , 0/`r signif(fitIdealPowCoarse$estimate[1],2)` | 1/`r signif(fitNonIdealExp$estimate[1],2)` , 0/`r signif(fitNonIdealPow$estimate[1],2)` | 1/`r signif(fitRealExp$estimate[1],2)` , 0/`r signif(fitRealPow$estimate[1],2)`
$\alpha^{set}/\alpha^{fit}$ | 2/`r signif(fitIdealExpFine$estimate[2],2)` , 0/`r signif(fitIdealPowFine$estimate[2],2)` | 2/`r signif(fitIdealExpCoarse$estimate[2],2)` , 0/`r signif(fitIdealPowCoarse$estimate[2],2)` | 2/`r signif(fitNonIdeal$estimate[2],2)` , 0/`r signif(fitNonIdealPow$estimate[2],2)` | 2/`r signif(fitRealExp$estimate[2],2)` , 0/`r signif(fitRealPow$estimate[2],2)`
$B^{set}/B^{fit}$           | 0/`r signif(fitIdealExpFine$estimate[3],2)` , 1/`r signif(fitIdealPowFine$estimate[3],2)` | 0/`r signif(fitIdealExpCoarse$estimate[3],2)` , 1/`r signif(fitIdealPowCoarse$estimate[3],2)` | 0/`r signif(fitNonIdeal$estimate[3],2)` , 1/`r signif(fitNonIdealPow$estimate[3],2)` | 0/`r signif(fitRealExp$estimate[3],2)` , 1/`r signif(fitRealPow$estimate[3],2)`
$\beta^{set}/\beta^{fit}$   | 0/`r signif(fitIdealExpFine$estimate[4],2)` , 3/`r signif(fitIdealPowFine$estimate[4],2)` | 0/`r signif(fitIdealExpCoarse$estimate[4],2)` , 3/`r signif(fitIdealPowCoarse$estimate[4],2)` | 0/`r signif(fitNonIdeal$estimate[4],2)` , 3/`r signif(fitNonIdealPow$estimate[4],2)` | 0/`r signif(fitRealExp$estimate[4],2)` , 3/`r signif(fitRealPow$estimate[4],2)`
$b^{set}/b^{fit}$           | 0/`r signif(fitIdealExpFine$estimate[5],2)` , 0/`r signif(fitIdealPowFine$estimate[5],2)` | 0/`r signif(fitIdealExpCoarse$estimate[5],2)` , 0/`r signif(fitIdealPowCoarse$estimate[5],2)` | 0/`r signif(fitNonIdeal$estimate[5],2)` , 0/`r signif(fitNonIdealPow$estimate[5],2)` | 0/`r signif(fitRealExp$estimate[5],2)` , 0/`r signif(fitRealPow$estimate[5],2)`
...
convRate <- data.frame( pT = seq(2,80,1),
                        rate = drop(t(turnOn[1:79,]) %*% ratePDF(seq(2,80,1),norm1_r,powerLaw1_r,norm2_r,powerLaw2_r,shift_r))
                      )

convRatePlot <- ggplot() +
        geom_line( data=convRate,
                   aes( x = pT,
                        y = rate/rate[1]
                      )
                 )
