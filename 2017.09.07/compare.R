...
if( !file.exists("three.csv") ){
  system("echo \"muPtGenInv\",\"theta\",\"st1_ring2\",\"dPhi12\",\"dPhi13\",\"dPhi14\",\"dPhi23\",\"dPhi24\",\"dPhi34\",\"dTheta12\",\"dTheta13\",\"dTheta14\",\"dTheta23\",\"dTheta24\",\"dTheta34\",\"dPhiS4\",\"dPhiS4A\",\"dPhiS3\",\"dPhiS3A\",\"clct1\",\"clct2\",\"clct3\",\"clct4\",\"fr1\",\"fr2\",\"fr3\",\"fr4\",\"rpc1\",\"rpc2\",\"rpc3\",\"rpc4\",\"ptXML\",\"train\",\"ranger\",\"gbm\",\"myPt\",\"row.names\" > three.csv")
...
df <- read.csv("three.csv",sep=',',header=T,row.names=37)

testSet <- data.frame(res = 1./df$myPt, muPtGen = 1./df$muPtGenInv, ptTrg = df$ptXML)
