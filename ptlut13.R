...
predictors2address13 <- function(df){
  ...
  address <- bitwOr(address, bitwShiftL(c(0,0,0,0,0,0,0,0,1,2,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(df$clct1)),0xF)+1],0+9+9) )
  address <- bitwOr(address, bitwShiftL(c(0,0,0,0,0,0,0,0,1,2,3,0,0,0,0,0)[bitwAnd(as.integer(as.character(df$clct3)),0xF)+1],0+9+9+3) )
  ...
  address <- bitwOr(address, bitwShiftL(bitwAnd(as.integer(as.character(df$fr1)),0x1),0+9+9+3+3+3) )
  address
}

address2predictors13 <- function(address){
  df <- data.frame(mode_inv = ifelse(bitwAnd(address,0x1C000000)==0x1C000000,14,0)) 
  df$dPhi13 <- bitwAnd(bitwShiftR(address,0),0x3FF)
  df$dPhi34 <- bitwAnd(bitwShiftR(address,0+10),0x1FF)
  df$dTheta13 <- 0
  df$dTheta34 <- 0
  df$clct1 <- factor( c(6,8,9,10)[bitwAnd(bitwShiftR(address,0+10+9),0x3)+1], levels=c(9,6,8,10))
  df$clct3 <- factor( c(6,8,9,10)[bitwAnd(bitwShiftR(address,0+10+9+2),0x3)+1], levels=c(9,6,8,10))
  df$clct4 <- factor( c(6,8,9,10)[bitwAnd(bitwShiftR(address,0+10+9+2+2),0x3)+1], levels=c(9,6,8,10))
  df$fr1 <- factor( c(0,1)[bitwAnd(bitwShiftR(address,0+10+9+2+2+2),0x1)+1], levels=c(0,1))
  df$fr3 <- 0
  df$fr4 <- 0  
  df
}
...
generatePtLUT13 <- function(){
  ...
  while( address_high < max_addr_high ){
    df$clct1 <- factor( c(6,8,9,10)[bitwAnd(bitwShiftR(address_high,0),0x3)+1], levels=c(9,6,8,10))
    df$clct3 <- factor( c(6,8,9,10)[bitwAnd(bitwShiftR(address_high,0+2),0x3)+1], levels=c(9,6,8,10))
