...
## Selecting best predictors in trees
...
We need to fit the model above into our 2Gb Look Up Table addressed with 30 bits

Let us use the following sub-optimal scheme of bits assignment:

  dPhi12 | dPhi13 | dPhi14 | dPhi23 | dPhi24 | dPhi34 
---------|--------|--------|--------|--------|---------
  [6:0]  |   --   |   --   | [6:0]  |   --   |  [6:0]

sign( dPhi23*dPhi12 ) | sign( dPhi34*dPhi12 ) | dTheta23 | clct1
----------------------|-----------------------|----------|-------
      [1]             |           [1]         |   [1:0]  | [1:0] 

c(0,0,0,0,0,0,1,0,2,0,3,0,0,0,0,0)

--- .class #id

## Other performance metrics: residuals
